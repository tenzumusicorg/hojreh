...
import CarouselItemDto, {
  CarouselListDto,
} from '../../dto/carousel/get-carouesl-list.dto';
import StaticsRepository from 'src/domain/static/repository/statics.repository';

export class CarouselListQuery {
  constructor() {}
}

@QueryHandler(CarouselListQuery)
export class CarouselListHandler implements IQueryHandler<CarouselListQuery> {
