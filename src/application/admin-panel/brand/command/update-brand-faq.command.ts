...
export class UpdateBrandFaqCommand {
  constructor(
...
@CommandHandler(UpdateBrandFaqCommand)
export class UpdateBrandFaqHandler
  implements ICommandHandler<UpdateBrandFaqCommand>
{
  constructor(
  ...
  async execute(command: UpdateBrandFaqCommand): Promise<void> {
    ...
    foundBrand.faq_list = this.faqRepository.updateFaq(
